...
1. Clone the repo:
        ...
        git clone git@github.com:alphagov/vcloud-net_launcher.git
...
3. Run the tests. Pull requests that add features must include unit tests,
   ...
   (https://github.com/alphagov/vcloud-net_launcher/blob/master/spec/integration/README.md)
...
6. Update the [CHANGELOG](https://github.com/alphagov/vcloud-net_launcher/blob/master/CHANGELOG.md)
